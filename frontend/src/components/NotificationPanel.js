...
const s = {
  ...
  ttl:{fontFamily:"'DM Serif Display',Georgia,serif",fontSize:20,fontWeight:600},
  ...
  rb:{background:'var(--surface-2)',border:'none',borderRadius:'50%',width:28,height:28,cursor:'pointer',color:'var(--green-mid)',fontWeight:700,flexShrink:0},
};