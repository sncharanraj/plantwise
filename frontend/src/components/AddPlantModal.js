      ...
      <div style={s.modal} className="animate-growIn">
        ...
        {step===STEPS.LOADING&&(
          <div style={s.lb}>
            ...
            <div className="animate-pulse" style={{fontFamily:'var(--font-display)',fontSize:20,color:'var(--olive)',marginBottom:20}}>{statusMsg}</div>
...
const s = {
  ...
  mt:{fontFamily:'var(--font-display)',fontSize:18,marginBottom:8,color:'var(--text-1)'},
