...
const s = {
  ...
  left:      {width:'44%',minHeight:'100vh',background:'linear-gradient(160deg,#3d4a2e 0%,#5a6e44 55%,#3d4a2e 100%)',position:'relative',overflow:'hidden',display:'flex',flexDirection:'column'},
  ...
  logoText:  {fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:36,fontWeight:600,color:'#f7f3ee',letterSpacing:'-0.01em'},
  tagline:   {fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:22,fontStyle:'italic',color:'rgba(247,243,238,0.8)',lineHeight:1.55,marginBottom:28,whiteSpace:'pre-line'},
  ...
  langBtn:   {padding:'5px 12px',borderRadius:100,border:'1.5px solid var(--border-mid)',background:'transparent',cursor:'pointer',fontSize:13,color:'var(--text-3)',transition:'all 0.2s',fontFamily:"'Outfit',system-ui,sans-serif"},
  langActive:{background:'var(--olive)',color:'var(--text-inv)',borderColor:'var(--olive)',fontWeight:600},
  mobileLogo:{display:'flex',alignItems:'center',gap:10,marginBottom:28},
  mobileLogoText:{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:28,fontWeight:600,color:'var(--text-1)'},
  ...
  modeBtn:   {flex:1,padding:'10px 16px',borderRadius:100,border:'none',background:'transparent',cursor:'pointer',fontSize:14,fontWeight:500,color:'var(--text-3)',transition:'all 0.22s',fontFamily:"'Outfit',system-ui,sans-serif"},
  modeBtnOn: {background:'var(--surface)',color:'var(--text-1)',fontWeight:600,boxShadow:'0 2px 8px rgba(30,30,24,0.1)'},
  formTitle: {fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:36,fontWeight:600,color:'var(--text-1)',marginBottom:6,lineHeight:1.2},
