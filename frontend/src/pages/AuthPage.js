...
const s = {
  ...
  logoText:  {fontFamily:"'Syne',sans-serif",fontSize:36,fontWeight:600,color:'#f7f3ee',letterSpacing:'-0.01em'},
  tagline:   {fontFamily:"'Syne',sans-serif",fontSize:22,fontStyle:'italic',color:'rgba(247,243,238,0.8)',lineHeight:1.55,marginBottom:28,whiteSpace:'pre-line'},
  ...
  langBtn:   {padding:'5px 12px',borderRadius:100,border:'1.5px solid var(--border-mid)',background:'transparent',cursor:'pointer',fontSize:13,color:'var(--text-3)',transition:'all 0.2s',fontFamily:"'Manrope',sans-serif"},
  ...
  mobileLogoText:{fontFamily:"'Syne',sans-serif",fontSize:28,fontWeight:600,color:'var(--text-1)'},
  ...
  modeBtn:   {flex:1,padding:'10px 16px',borderRadius:100,border:'none',background:'transparent',cursor:'pointer',fontSize:14,fontWeight:500,color:'var(--text-3)',transition:'all 0.22s',fontFamily:"'Manrope',sans-serif"},
  modeBtnOn: {background:'var(--surface)',color:'var(--text-1)',fontWeight:600,boxShadow:'0 2px 8px rgba(30,30,24,0.1)'},
  formTitle: {fontFamily:"'Syne',sans-serif",fontSize:36,fontWeight:600,color:'var(--text-1)',marginBottom:6,lineHeight:1.2},
